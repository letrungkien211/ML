...
/**
 * @brief print the elements of matrix
 * 
 * @param matrix CvMat pointer of matrix
 */
// void printMat(CvMat *matrix){
//   int col=matrix->width;
//   int type = CV_MAT_TYPE(matrix->type);

//   if(type==CV_32SC1){
//     for (int y = 0; y < matrix->height; y++){
//       for (int x = 0; x < matrix->width; x++){
// 	printf("%d ", matrix -> data.i[y*col + x]);
//       }
//       printf("\n");
//     }
//     printf("\n");
...
//     for (int y = 0; y < matrix->height; y++){
//       for (int x = 0; x < matrix->width; x++){
// 	printf("%lf ", matrix -> data.fl[y*col + x]);
//       }
//       printf("\n");
//     }
//     printf("\n");
...
//     for (int y = 0; y < matrix->height; y++){
//       for (int x = 0; x < matrix->width; x++){
// 	printf("%lf %lf", matrix -> data.fl[(y*col + x)*2 + 0], matrix -> data.fl[(y*col + x)*2 + 1]);
//       }
//       printf("\n");
//     }
//     printf("\n");
